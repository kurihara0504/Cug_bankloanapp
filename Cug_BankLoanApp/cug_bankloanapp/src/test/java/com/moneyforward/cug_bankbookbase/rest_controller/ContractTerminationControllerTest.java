...
public class ContractTerminationControllerTest {
  ...
  /** テスト対象クラス. */
  @Autowired
  private ContractTerminationController contractTerminationController;
  ...
  public void before() throws Exception {
    ...
    ReflectionTestUtils.setField(contractTerminationController, "baseSession", baseSession);
    ReflectionTestUtils.setField(contractTerminationController, "contractTerminationService", contractTerminationService);
  ...
  @Test
  public void testContractTerminationReportNormalMax() throws Exception {

    // Jsonデータ文字列を生成する
    String accountId = "01234567890123456789";
    String contractId = "0123456789012345678";
    String type = "101";
    String queryPath = "?contract_id=" + contractId + "&type=" + type;

    //stubを呼び出す
    MvcResult mvcResult = mvc.perform(
        get("/loan/accounts/"+ accountId + "/contract_termination_report" + queryPath)
    ...
    Mockito.when(contractTerminationService.getContractTerminationService(ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any())).thenReturn(array);
   ...
   */
  @Test
  public void testContractTerminationReportNormalMin() throws Exception {
   ...
   */
  @Test
  public void testContractTerminationReportErrorReportIdIsNull() throws Exception {

    // Jsonデータ文字列を生成する
    String accountId = "1";
    String type = "1";
    String queryPath = "?contract_id=" + "&type=" + type;
   ...
   */
  @Test
  public void testContractTerminationReportErrorRefererIsNull() throws Exception {
   ...
   */
  @Test
  public void testContractTerminationReportErrorRefererIsUnexpected() throws Exception {
