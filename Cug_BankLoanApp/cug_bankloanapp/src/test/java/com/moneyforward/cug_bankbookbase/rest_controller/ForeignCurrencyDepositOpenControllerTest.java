...
/**
 * 外貨定期預金預入のご案内取得要求コントローラ　テストクラス.
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class ForeignCurrencyDepositOpenControllerTest {
  ...
  /** テスト対象クラス. */
  @Autowired
  private ForeignCurrencyDepositOpenController foreignCurrencyDepositOpenController;
  ...
  //@Beforeは@Testが実行される前に毎回実行される
  @Before
  public void before() throws Exception {
	
    mvc = MockMvcBuilders.webAppContextSetup(this.wac).build();
    ReflectionTestUtils.setField(foreignCurrencyDepositOpenController, "baseSession", baseSession);
    ReflectionTestUtils.setField(foreignCurrencyDepositOpenController, "foreignCurrencyDepositOpenService", foreignCurrencyDepositOpenService);
  ...
  @Test
  public void testForeignCurrencyDepositOpenReportNormalMax() throws Exception {
    ...
    MvcResult mvcResult = mvc.perform(
        get("/loan/accounts/"+ accountId + "/foreign_currency_deposit_open_report" + queryPath)
    ...
    Mockito.when(foreignCurrencyDepositOpenService.getForeignCurrencyDepositOpenService(ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any())).thenReturn(array);
   ...
   */
  @Test
  public void testForeignCurrencyDepositOpenReportNormalMin() throws Exception {
   ...
   */
  @Test
  public void testForeignCurrencyDepositOpenReportErrorReportIdIsNull() throws Exception {
   ...
   */
  @Test
  public void testForeignCurrencyDepositOpenReportErrorRefererIsNull() throws Exception {
   ...
   */
  @Test
  public void testForeignCurrencyDepositOpenReportErrorRefererIsUnexpected() throws Exception {
