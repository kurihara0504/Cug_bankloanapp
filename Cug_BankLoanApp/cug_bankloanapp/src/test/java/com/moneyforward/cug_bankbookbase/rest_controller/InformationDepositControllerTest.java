...
/**
 * 定期預金期日のご案内取得要求コントローラ　テストクラス.
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class InformationDepositControllerTest {
  ...
  /** テスト対象クラス. */
  @Autowired
  private InformationDepositController informationDepositController;
  ...
  public void before() throws Exception {
    ...
    ReflectionTestUtils.setField(informationDepositController, "baseSession", baseSession);
    ReflectionTestUtils.setField(informationDepositController, "informationDepositService", informationDepositService);
  ...
  public void testAccountIdReportIdMax() throws Exception {
    ...
    MvcResult mvcResult = mvc.perform(
        get("/loan/accounts/"+ accountId + "/information_deposit_report" + report)
    ...
    Mockito.when(informationDepositService.getInformationDeposit(ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any())).thenReturn(array);
