...
/**
 * 金利見直し方法選択のご案内コントローラ　テストクラス.
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class InformationSelectingRateControllerTest {
  ...
  /** テスト対象クラス. */
  @Autowired
  private InformationSelectingRateController informationSelectingRateController;
  ...
  public void before() throws Exception {
    ...
    ReflectionTestUtils.setField(informationSelectingRateController, "baseSession", baseSession);
    ReflectionTestUtils.setField(informationSelectingRateController, "informationSelectingRateService", informationSelectingRateService);
  ...
  public void testAccountIdReportIdMax() throws Exception {
    ...
    MvcResult mvcResult = mvc.perform(
        get("/loan/accounts/"+ accountId + "/information_selecting_rate_report" + query)
    ...
    Mockito.when(informationSelectingRateService.getInformationSelectingRate(ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any(), ArgumentMatchers.any())).thenReturn(array);
