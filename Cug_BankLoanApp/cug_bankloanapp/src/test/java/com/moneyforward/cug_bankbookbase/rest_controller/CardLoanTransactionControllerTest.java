...
/**
 * カードローン取引内容通知照会コントローラ　テストクラス.
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class CardLoanTransactionControllerTest {
  ...
  /** テスト対象クラス. */
  @Autowired
  private CardLoanTransactionController cardLoanTransactionController;
  ...
  public void before() throws Exception {
    ...
    ReflectionTestUtils.setField(cardLoanTransactionController, "baseSession", baseSession);
    ReflectionTestUtils.setField(cardLoanTransactionController, "cardLoanTransactionService", cardLoanTransactionService);
  ...
  @Test
  public void testCardLoanTransactionReportNormalMax() throws Exception {
    ...
    MvcResult mvcResult = mvc.perform(
        get("/loan/accounts/"+ accountId + "/card_loan_transaction_report" + queryPath)
    ...
    Mockito.when(cardLoanTransactionService.getCardLoanTransactionService(ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any(),ArgumentMatchers.any())).thenReturn(array);
   ...
   */
  @Test
  public void testCardLoanTransactionReportMin() throws Exception {
   ...
   */
  @Test
  public void testCardLoanTransactionReportErrorReportIdIsNull() throws Exception {
   ...
   */
  @Test
  public void testCardLoanTransactionReportErrorRefererIsNull() throws Exception {
   ...
   */
  @Test
  public void testCardLoanTransactionReportErrorRefererIsUnexpected() throws Exception {
