...
public class ReportForeignCurrencyDueDateDto {
  ...
  /**
   * 外貨定期預金期日のご案内識別子を取得する.
   *
   * 外貨定期預金期日のご案内識別子を呼び出し元に返却する
   * @return 外貨定期預金期日のご案内識別子
   */
  public String getId() {
    return id;
  }
  /**
   * 外貨定期預金期日のご案内識別子を設定する.
   *
   * 受け取った外貨定期預金期日のご案内識別子を設定する
   * @param id 外貨定期預金期日のご案内識別子
   */
